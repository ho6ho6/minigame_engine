...
- RTV / SRV分離
- ImGuiとの統合
- Resize時のDisplayFramebufferScale制御
...
- ユーザは「大乱闘スマッシュブラザーズ｣のコンテンツにある｢ステージ作り｣のように、元々ある地形・動くものなどをAssetsウィンドウから選択して、ステージを作成する。
...
### ビルド方法
コンパイル方法:Windows PowerShell->cmake --build . --config Debug --target run </br>
Cmake:cmake .. -G "Visual Studio 17 2022" -A x64  </br>
